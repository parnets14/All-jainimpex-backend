...
//           Author: 'Jain Impex',
//           Subject: `Salary Slip for ${salary.periodString}`
//         }
//       });
...
//         .fontSize(24)
//         .font('Helvetica-Bold')
//         .text('JAIN IMPEX', 50, 40)
//         .fontSize(12)
//         .font('Helvetica')
//         .text('Plumbing Solutions & Services', 50, 70)
//         .text('123 Market Road, New Delhi - 110001', 50, 85)
//         .text('GSTIN: 07ABCDE1234F125 | PAN: ABCDE1234F', 50, 100);
...
//         .fontSize(12)
//         .font('Helvetica')
//         .text(`For the month of ${salary.periodString}`, 0, 160, { align: 'center' });
...
//         .text(`Designation: ${salary.employee.designation}`, col1, employeeTop + 55)
//         .text(`Department: ${salary.employee.department}`, col2, employeeTop + 25)
//         .text(`Payment Date: ${new Date().toLocaleDateString()}`, col2, employeeTop + 40)
//         .text(`Days Worked: ${salary.presentDays}/${salary.workingDays}`, col2, employeeTop + 55);
...
//         ['House Rent Allowance (HRA)', salary.allowances.hra],
//         ['Conveyance Allowance', salary.allowances.conveyance],
//         ['Medical Allowance', salary.allowances.medicalAllowance],
//         ['Special Allowance', salary.allowances.specialAllowance]
//       ];
...
//         .text(salary.grossSalary.toFixed(2), 400, currentY + 5, { align: 'right' });
...
//       const deductions = [
//         ['Provident Fund (PF)', salary.deductions.pf],
//         ['Professional Tax', salary.deductions.professionalTax],
//         ['Tax Deducted at Source (TDS)', salary.deductions.tds],
...
//         .text(salary.deductions.total.toFixed(2), 400, currentY + 5, { align: 'right' });
...
//         .fontSize(14)
//         .text(`₹ ${salary.netSalary.toFixed(2)}`, 400, netSalaryTop + 13, { align: 'right' });

//       // Attendance summary
//       const attendanceTop = netSalaryTop + 60;

//       doc
//         .fillColor('#1e293b')
//         .fontSize(10)
//         .font('Helvetica-Bold')
//         .text('ATTENDANCE SUMMARY', 50, attendanceTop);

//       const attendanceData = [
//         ['Working Days', salary.workingDays],
//         ['Present Days', salary.presentDays],
//         ['Absent Days', salary.absentDays],
//         ['Leave Days', salary.leaveDays],
//         ['Overtime Hours', salary.overtimeHours]
//       ];

//       currentY = attendanceTop + 20;
...
//           .fillColor('#1e3a8a')
//           .font('Helvetica-Bold')
//           .text(value.toString(), 150, currentY);
//         currentY += 15;
//       });
...
//       ['Employee Signature', 'HR Manager', 'Authorized Signatory'].forEach((label, index) => {
