...
import ratioAnalysisRoutes from './routes/ratioAnalysisRoutes.js';
import fundsFlowRoutes from './routes/fundsFlowRoutes.js';
...
import serviceChargeMasterRoutes from './routes/serviceChargeMasterRoutes.js';
...
app.use('/api/service-charges', serviceChargeMasterRoutes);
...
app.use('/api/ratio-analysis', ratioAnalysisRoutes);
app.use('/api/funds-flow', fundsFlowRoutes);
